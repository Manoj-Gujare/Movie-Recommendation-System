...
movies_dict = pickle.load(open('D:\Projects\ML\Movie Recommendation System\Movie.pkl','rb'))
movies = pd.DataFrame(movies_dict)

similarity = pickle.load(open('D:\Projects\ML\Movie Recommendation System\Similarity.pkl','rb'))
